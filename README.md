...
- Modularity: the core operations rely on a small set of primitive [matrix operations](https://wiegerw.github.io/nerva-torch/nerva-torch.html#_matrix_operations), making the logic easy to inspect, test, and validate.
