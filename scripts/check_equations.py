...
LAYERS_FILE_DEFAULT = os.path.join(ROOT, 'src', 'nerva_torch', 'layers.py')
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument('--layers-file', default=LAYERS_FILE_DEFAULT, help='Path to layers.py to inspect (default: src/nerva_torch/layers.py)')
