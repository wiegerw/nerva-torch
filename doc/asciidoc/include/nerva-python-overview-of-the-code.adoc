...
|`link:../../../src/nerva_torch/activation_functions.py[activation_functions.py]`
|Activation functions.

|`link:../../../src/nerva_torch/loss_functions.py[loss_functions.py]`
|Loss functions.

|`link:../../../src/nerva_torch/weights.py[weights.py]`
|Weight initialization functions.

|`link:../../../src/nerva_torch/optimizers.py[optimizers.py]`
|Optimizer functions, for updating neural network parameters using their gradients.

|`link:../../../src/nerva_torch/learning_rate_schedulers.py[learning_rate_schedulers.py]`
|Learning rate schedulers, for updating the learning rate during training.

|`link:../../../src/nerva_torch/training.py[training.py]`
...
[source,python]
----
include::../../../src/nerva_torch/training.py[tag=sgd]
----
...
[source,python]
----
include::../../../src/nerva_torch/training.py[tag=sgd_plain]
----
